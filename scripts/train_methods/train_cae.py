...
def main(cfg: CAETrainingConfig):
    ...
    for num in num_features:
        model = MLP(
            in_features=d_in,
            out_features=d_out,
            num_cells=cfg.diff_selector.num_cells,
        ...
        diff_selector.fit(
                train_loader,
                val_loader,
                lr=cfg.diff_selector.lr,
                nepochs=cfg.diff_selector.nepochs,
                loss_fn=nn.CrossEntropyLoss(),
                patience=cfg.diff_selector.patience,
                verbose=False)
