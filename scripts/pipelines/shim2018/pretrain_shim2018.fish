...
for dataset in $datasets
    ...
    set -a jobs "uv run scripts/pretrain_models/pretrain_shim2018.py -m output_artifact_aliases=[\"$output_alias\"] dataset@_global_=$dataset$speed_suffix dataset_artifact_name="(string join , $dataset_artifact_names)" $extra_opts"
end
