        ...
        yaml.dump(
            {
                ...
                **{f"{k}": v for k, v in eval_params.items()},
...
def main(args):
    ...
    write_eval_results(
        args.results_folder / generate_slug(2),
        metrics,
        args.method,
        __file__,
        ...
        {
            "eval_seed": eval_seed,
            "dataset_train_path": str(train_dataset_path),
            "dataset_val_path": str(val_dataset_path),
            "dataset_test_path": str(test_dataset_path),
            "budget": d_in,
        },
        args.dataset_type,
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_fraction_name", type=str, default="val")
    ...
    parser.add_argument("--results_folder", type=Path, default=Path("results/static"))
