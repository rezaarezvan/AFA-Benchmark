...
#SBATCH --output=/mimer/NOBACKUP/groups/meta-project/projects/AFA-Benchmark/logs/slurm/pretrain_zannone2019_%j.out

module load virtualenv

if uv run src/afa_rl/zannone2019/scripts/pretrain_zannone2019.py \
    ...
    suffix="_completed"
    log_file="/mimer/NOBACKUP/groups/meta-project/projects/AFA-Benchmark/logs/slurm/pretrain_zannone2019_${SLURM_JOB_ID}.out"
