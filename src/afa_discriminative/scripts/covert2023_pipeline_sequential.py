...
import yaml
import time
from afa_discriminative.scripts.pretrain_covert2023 import main as pretrain_main
from afa_discriminative.scripts.train_covert2023 import main as train_main
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(f"models/pretrained/covert2023/{timestr}"),
        help="Path to the folder containing pretrained models",
    )
    parser.add_argument(
        "--method_folder",
        type=Path,
        default=Path(f"models/methods/covert2023/{timestr}"),
        help="Path to the folder containing method models",
    )
    parser.add_argument(
        "--pretrain_config_path",
        type=Path,
        default=Path("configs/covert2023/pretrain_covert2023.yml"),
        help="Path to the pretrain configuration file",
    )
    parser.add_argument(
        "--train_config_path",
        type=Path,
        default=Path("configs/covert2023/train_covert2023.yml"),
        help="Path to the train configuration file",
    )
    parser.add_argument(
        "--pipeline_config_path",
        type=Path,
        default=Path("configs/covert2023/pipeline.yml"),
